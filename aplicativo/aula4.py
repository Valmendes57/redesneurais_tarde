# TODO:Objetivo
#1. Distância Euclidiana(1D,2D,3D, n....)
#2. méida (cálculo do EAR)(Eye Aspect Radio)- Proporção do olho
...
#FIXME: EAR ( usando usando distância euclidiana)
    ...
    while cap.isOpened():
        ...
        try:
            for face_landmarks in saida_facemesh.multi_face_landmarks:
                ...
                #FIXME: aula amaha (chamar o calculo ear, mostrar o calculo no frame)
